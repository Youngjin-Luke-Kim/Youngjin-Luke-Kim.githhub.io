...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: 'Embarked on new journey at SCCAD under Prof. Sungkyu Lim',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/Youngjin-Luke-Kim", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/yjlukekim", "_blank");
        },
      },{
        id: 'social-scholar',
